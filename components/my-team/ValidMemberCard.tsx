...
import { VALID_MEMBER_ICON } from '../custom-icons';
                    ...
                    <div className="flex justify-between w-full bg-[#1f1f1f] border border-[#242424] items-start pb-4 rounded-[10px] p-3">
                        ...
                        <div className="border border-[#805c33] rounded-full ">
                            ...
                            <div className="flex flex-col ml-2">
                                <span className="font-sora text-[14px] font-semibold flex items-center">{member.username} <img src={VALID_MEMBER_ICON}  className='w-[15px] h-[15px] ml-1'/></span>
                                <span className="text-[11px] text-[#bdbdbd] font-mono font-medium">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                {member.subscribtionDetails.longVideoSectionSubDate.vip1 && 
                                    <div className="flex items-center font-sora text-[12px]   text-white">
                                        <img src="/vip-icons/movie/vip1.png" className="w-[15px] mr-1"/>
                                        VIP1
                                    </div>
                                }
