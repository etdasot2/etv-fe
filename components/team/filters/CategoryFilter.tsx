...
export default function FilterFriendsDropDown({ onFilterChange }: CategoryFilterProps) {
  const [isOpen, setIsOpen] = useState(false);
  const [selectedItemKey, setSelectedItemKey] = useState('activeFriends');
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        {t(`team.filters.${selectedItemKey}`)}
        <div
