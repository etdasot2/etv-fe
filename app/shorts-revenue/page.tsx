...
import PackagesShorts from '@/components/shorts-revenue/Packages'
import RevenueStatsShorts from '@/components/shorts-revenue/Stats'

const ShortsMemberCenter = () => {
  const { t } = useTranslation();

  return (
    <div className="bg-[#0f0f0f] text-white min-h-screen relative"
    >
      <img src="/assets/download-14.png" className=" max-w-[435px] absolute top-0 left-1/1 w-full h-[400px] opacity-[.5]" />

      <BackTitle
        title={t('shortsRevenue.title')}
...
export default ShortsMemberCenter